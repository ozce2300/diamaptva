...
})({"lqk7c":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "da0714b3bbb30d1a";
"use strict";
...
},{}],"7W1gq":[function(require,module,exports) {
...
function kurs(data) {
    ...
    let sexStorstaKurserna = kursData.map((item)=>({
        ...
        })).sort((a, b)=>b.applicantsTotal - a.applicantsTotal).slice(0, 6);
                ...
                x: {
                    ticks: {
                        callback: function(value) {
                            value++;
                            if (value.toString().length > 10) return value.toString().substring(1, 10) + "...";
                            return value;
                        }
                    }
                }
...
function program(data) {
    ...
    let femStorsta = programData.map((item)=>({
            name: item.name,
            applicantsTotal: item.applicantsTotal
        })).sort((a, b)=>b.applicantsTotal - a.applicantsTotal).slice(0, 5);
    new (0, _autoDefault.default)(ftx, {
        type: "doughnut",
        data: {
            labels: femStorsta.map((item)=>item.name),
            datasets: [
                {
                    label: "Fem mest s\xf6kta programmen",
...
},{}]},["lqk7c","7W1gq"], "7W1gq", "parcelRequire55cd")

//# sourceMappingURL=diagram.bbb30d1a.js.map
